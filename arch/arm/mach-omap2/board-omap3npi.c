...
static struct spi_board_info board_spi3_board_info[] = {
    {
        ...
        .max_speed_hz = 375000, /* Speed SPI. */
        .bus_num     = 1,       /* Number bus McSPI */
...
static int npi_enable_lcd(struct omap_dss_device *dssdev)
{
    ...
    if (gpio_is_valid(npi_config.lcd_pwren)) {
        ...
        gpio_direction_output(npi_config.lcd_pwren, 1);
...
//    u8 byte = 0;
//    int err;
//    err = twl_i2c_write_u8(TWL4030_MODULE_PM_MASTER, 0x2C,
//                           R_SEQ_ADD_A2S);

//    //    err = twl_i2c_write_u8(TWL4030_MODULE_PM_MASTER, 0x10,
//    //                           R_MEMORY_ADDRESS);

//    //    err = twl_i2c_read_u8(TWL4030_MODULE_PM_MASTER, &byte,
//    //                          R_MEMORY_DATA);
...
*/   
    ...
    //omap_mux_write(mux_partition, OMAP3_CONTROL_PADCONF_SYS_OFF_MODE_OFFSET, /*OMAP_PULL_UP | */OMAP_MUX_MODE0 | OMAP_PIN_OUTPUT);
